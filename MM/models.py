...
class Warehouse(models.Model):
    ...
    whtype = models.CharField(choices=WAREHOUSE_TYPES, blank=False, null=False, verbose_name='Warehouse Type', help_text='describe, is it consider COLD, Misc, Frozen...')
...
class MaterialMaster(models.Model):
    ...
    UOP = models.CharField(choices=MEASURE_UNITS, unique=False, null=False, verbose_name='Unit of Measure Purchase')
    UOC = models.CharField(choices=MEASURE_UNITS, unique=False, null=False, verbose_name='Unit of Measure Consume', help_text='note: Unit of consume will be the unit used to store stock and to move inventory')
