# Generated by Django 4.0.7 on 2022-10-12 06:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ProductNamePos', models.CharField(max_length=150, unique=True, verbose_name='Product Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('RecipeName', models.CharField(max_length=150, unique=True, verbose_name='Product Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('whtype', models.CharField(choices=[('Frozen', 'Frozen'), ('Cold', 'Cold'), ('Dry', 'Dry'), ('General', 'General'), ('Misc.', 'Misc.')], help_text='describe, is it consider COLD, Misc, Frozen...', max_length=25, verbose_name='Warehouse Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateofWastage', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Date of Wastage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateofSale', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Date of Sale')),
                ('ProductNamePos', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='MM.products')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateofProcessed', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Date of Process')),
                ('ProductNamePos', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='MM.products')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warehouse', models.ForeignKey(help_text='Where it is store, internaly after inward', on_delete=django.db.models.deletion.DO_NOTHING, to='MM.warehouse', verbose_name='Where it Store / Warehouse')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Date of Invoice')),
                ('isPosted', models.BooleanField(default=True)),
                ('note', models.CharField(blank=True, default='N/A', max_length=100)),
                ('time_stamp', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Updated at')),
